...
public class CinemaController {
    ...
    public static void addCinema(int cineplexId, String name, CinemaClass cinemaClass, char[][] cinemaLayout)
            throws InvalidIdException {
        cineplexId = normaliseId(cineplexId);
        Cineplex cineplex = CineplexController.getCineplex(cineplexId + 1);
        Cinema newCinema = new Cinema(name, cinemaClass, cinemaLayout);
